...
class GroupsController {
    ...
    fun getGroupInformationFromSid(@PathVariable("sid") sid: String): ResponseEntity<String> {
        var message: String = ""
        var status: HttpStatus = HttpStatus.INTERNAL_SERVER_ERROR
    ...
    fun deleteGroupInformationFromSid(@PathVariable("sid") sid: String): ResponseEntity<String> {
        var message: String = ""
        var status: HttpStatus = HttpStatus.INTERNAL_SERVER_ERROR

        transaction {
            val count = UserGroups.deleteWhere { UserGroups.sid eq sid }
